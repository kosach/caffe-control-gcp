...
describe('webhook', () => {
  ...
  beforeEach(() => {
    ...
    // Mock Poster API response (dash.getTransaction returns array)
    mockedAxios.get.mockResolvedValue({
      data: {
        response: [{
          transaction_id: '123',
          date_start: '1518873040083',
          date_start_new: '1518873040083',
  ...
  describe('Real Poster webhook format', () => {
    test('handles real Poster format with changed action', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith(
        expect.stringContaining('https://joinposter.com/api/dash.getTransaction'),
